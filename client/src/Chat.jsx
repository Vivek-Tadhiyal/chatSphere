...
export default function Chat() {
    ...
    function handleMessage(ev) { //handle incoming messages
    ...
    function sendFile(ev) {
        ...
        reader.readAsDataURL(ev.target.files[0]); //base64data
        reader.onload = () => {
            sendMessage(null, {
    ...
    useEffect(() => {
        axios.get('/people').then(res => {
            ...
            //console.log("offline people are : ");
        ...
        <div className="flex h-screen">
            ...
            <div className="flex-grow">
                ...
                <div className="p-2 text-center flex items-center justify-center">
                    ...
                    <button
                        onClick={logout}
                     className="text-sm bg-blue-100 text-gray-500 py-1 px-2 border rounded-sm">logout</button>
                </div>
            </div>
                ...
                <div className="flex-grow">
                    {!selectedUserId && (
                        <div className="flex h-full flex-grow items-center justify-center">
                            <div className="text-gray-300">&larr; Select someone to chat with</div>
                        </div>
                    )}
                    {!!selectedUserId && (
